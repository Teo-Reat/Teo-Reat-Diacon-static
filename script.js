 ...
 */
	!function (t, n) {
		...
		var r = [], s = Object.getPrototypeOf, a = r.slice, l = r.flat ? function (e) {
			...
			}, c = r.push, d = r.indexOf, u = {}, p = u.toString, f = u.hasOwnProperty, h = f.toString, v = h.call(Object),
			g = {}, y = function (e) {
		...
		T.fn = T.prototype = {
			...
			for ("boolean" == typeof s && (c = s, s = arguments[a] || {}, a++), "object" == typeof s || y(s) || (s = {}), a === l && (s = this, a--); a < l; a++) if (null != (e = arguments[a])) for (t in e) i = e[t], "__proto__" !== t && s !== i && (c && i && (T.isPlainObject(i) || (o = Array.isArray(i))) ? (n = s[t], r = o && !Array.isArray(n) ? [] : o || T.isPlainObject(n) ? n : {}, o = !1, s[t] = T.extend(c, r, i)) : void 0 !== i && (s[t] = i));
			return s
		}, T.extend({
 ...
 */
			function (e) {
				var t, n, i, o, r, s, a, l, c, d, u, p, f, h, v, g, y, m, w, b = "sizzle" + 1 * new Date,
					...
					U = new RegExp(q + "|>"), X = new RegExp(z), Y = new RegExp("^" + M + "$"), V = {
						ID: new RegExp("^#(" + M + ")"),
						CLASS: new RegExp("^\\.(" + M + ")"),
						TAG: new RegExp("^(" + M + "|[*])"),
						ATTR: new RegExp("^" + I),
				...
				try {
					H.apply(D = N.call(x.childNodes), x.childNodes), D[x.childNodes.length].nodeType
				} catch (e) {
					H = {
				...
				for (t in n = ae.support = {}, r = ae.isXML = function (e) {
					...
					return s != f && 9 === s.nodeType && s.documentElement ? (h = (f = s).documentElement, v = !r(f), x != f && (o = f.defaultView) && o.top !== o && (o.addEventListener ? o.addEventListener("unload", re, !1) : o.attachEvent && o.attachEvent("onunload", re)), n.scope = de((function (e) {
						...
						return i || (1 & (i = (e.ownerDocument || e) == (t.ownerDocument || t) ? e.compareDocumentPosition(t) : 1) || !n.sortDetached && t.compareDocumentPosition(e) === i ? e == f || e.ownerDocument == x && w(x, e) ? -1 : t == f || t.ownerDocument == x && w(x, t) ? 1 : d ? _(d, e) - _(d, t) : 0 : 4 & i ? -1 : 1)
					} : function (e, t) {
						if (e === t) return u = !0, 0;
						var n, i = 0, o = e.parentNode, r = t.parentNode, s = [e], a = [t];
						if (!o || !r) return e == f ? -1 : t == f ? 1 : o ? -1 : r ? 1 : d ? _(d, e) - _(d, t) : 0;
					...
					return i && !i[b] && (i = Te(i)), o && !o[b] && (o = Te(o, r)), ce((function (r, s, a, l) {
						...
						if (r) {
							if (o || e) {
								...
								for (d = y.length; d--;) (u = y[d]) && (c = o ? _(r, u) : p[d]) > -1 && (r[c] = !(s[c] = u))
							}
				...
				function Se(e) {
					for (var t, n, o, r = e.length, s = i.relative[e[0].type], a = s || i.relative[" "], l = s ? 1 : 0, d = be((function (e) {
						...
						if ((n = i.filter[e[l].type].apply(null, e[l].matches))[b]) {
							...
							return Te(l > 1 && xe(p), l > 1 && we(e.slice(0, l - 1).concat({value: " " === e[l - 2].type ? "*" : ""})).replace(R, "$1"), n, l < o && Se(e.slice(l, o)), o < r && Se(e = e.slice(o)), o < r && we(e))
						}
						p.push(n)
					}
					return xe(p)
					...
					if (!a) {
						...
						(a = $(e, function (e, t) {
							var n = t.length > 0, o = e.length > 0, r = function (r, s, a, l, d) {
								var u, h, g, y = 0, m = "0", w = r && [], b = [], x = c,
									T = r || o && i.find.TAG("*", d), S = k += null == x ? 1 : Math.random() || .1,
									C = T.length;
		...
		T.fn.extend({
			...
			T.fn[e] = function (n, i) {
				...
				return "Until" !== e.slice(-5) && (i = n), i && "string" == typeof i && (o = T.filter(i, o)), this.length > 1 && (_[e] || T.uniqueSort(o), N.test(e) && o.reverse()), this.pushStack(o)
			}
		}));
		var q = /[^\x20\t\r\n\f]+/g;
		...
		T.Callbacks = function (e) {
			...
			Deferred: function (e) {
				var t = [["notify", "progress", T.Callbacks("memory"), T.Callbacks("memory"), 2], ["resolve", "done", T.Callbacks("once memory"), T.Callbacks("once memory"), 0, "resolved"], ["reject", "fail", T.Callbacks("once memory"), T.Callbacks("once memory"), 1, "rejected"]],
					i = "pending", o = {
						state: function () {
								...
								return function () {
									var a = this, l = arguments, c = function () {
										...
										if (!(e < r)) {
											...
											c = n && ("object" == typeof n || "function" == typeof n) && n.then, y(c) ? o ? c.call(n, s(r, t, M, o), s(r, t, I, o)) : (r++, c.call(n, s(r, t, M, o), s(r, t, I, o), s(r, t, M, t.notifyWith))) : (i !== M && (a = void 0, l = [n]), (o || t.resolveWith)(a, l))
										}
									}, d = o ? c : function () {
										try {
											c()
										} catch (n) {
											T.Deferred.exceptionHook && T.Deferred.exceptionHook(n, d.stackTrace), e + 1 >= r && (i !== I && (a = void 0, l = [n]), t.rejectWith(a, l))
										}
									};
							...
							return T.Deferred((function (n) {
								t[0][3].add(s(0, n, y(o) ? o : M, n.notifyWith)), t[1][3].add(s(0, n, y(e) ? e : M)), t[2][3].add(s(0, n, y(i) ? i : I))
							})).promise()
						}, promise: function (e) {
				...
				var t = arguments.length, n = t, i = Array(n), o = a.call(arguments), r = T.Deferred(),
					s = function (e) {
						return function (n) {
		...
		T.fn.ready = function (e) {
			...
			isReady: !1, readyWait: 1, ready: function (e) {
				(!0 === e ? --T.readyWait : T.isReady) || (T.isReady = !0, !0 !== e && --T.readyWait > 0 || R.resolveWith(w, [T]))
			}
		}), T.ready.then = R.then, "complete" === w.readyState || "loading" !== w.readyState && !w.documentElement.doScroll ? n.setTimeout(T.ready) : (w.addEventListener("DOMContentLoaded", F), n.addEventListener("load", F));
		var B = function (e, t, n, i, o, r, s) {
			var a = 0, l = e.length, c = null == n;
			if ("object" === k(n)) for (a in o = !0, n) B(e, t, a, n[a], !0, r, s); else if (void 0 !== i && (o = !0, y(i) || (s = !0), c && (s ? (t.call(e, i), t = null) : (c = t, t = function (e, t, n) {
				return c.call(T(e), n)
		...
		var ne = /[+-]?(?:\d*\.|)\d+(?:[eE][+-]?\d+|)/.source,
			...
			re = w.documentElement, se = function (e) {
		...
		function ke(e, t, n, i, o) {
			...
			for (u.textContent = "", f = 0; r = p[f++];) if (i && T.inArray(r, i) > -1) o && o.push(r); else if (c = se(r), s = we(u.appendChild(r), "script"), c && be(s), n) for (d = 0; r = s[d++];) ye.test(r.type || "") && n.push(r);
			return u
		}
			...
			n ? (J.set(e, t, !1), T.event.add(e, t, {
				namespace: !1, handler: function (e) {
					...
					if (1 & e.isTrigger && this[t]) {
						if (r.length) (T.event.special[t] || {}).delegateType && e.stopPropagation(); else if (r = a.call(arguments), J.set(this, t, r), i = n(this, t), this[t](), r !== (o = J.get(this, t)) || i ? J.set(this, t, !1) : o = {}, r !== o) return e.stopImmediatePropagation(), e.preventDefault(), o.value
		...
		T.event = {
			global: {}, add: function (e, t, n, i, o) {
				...
				if (G(e)) for (n.handler && (n = (r = n).handler, o = r.selector), o && T.find.matchesSelector(re, o), n.guid || (n.guid = T.guid++), (l = g.events) || (l = g.events = Object.create(null)), (s = g.handle) || (s = g.handle = function (t) {
					return void 0 !== T && T.event.triggered !== t.type ? T.event.dispatch.apply(e, arguments) : void 0
				}), c = (t = (t || "").match(q) || [""]).length; c--;) f = v = (a = Ce.exec(t[c]) || [])[1], h = (a[2] || "").split(".").sort(), f && (u = T.event.special[f] || {}, f = (o ? u.delegateType : u.bindType) || f, u = T.event.special[f] || {}, d = T.extend({
					type: f,
					origType: v,
					data: i,
					handler: n,
				...
				if (g && (l = g.events)) {
					for (c = (t = (t || "").match(q) || [""]).length; c--;) if (f = v = (a = Ce.exec(t[c]) || [])[1], h = (a[2] || "").split(".").sort(), f) {
				...
				var t, n, i, o, r, s, a = new Array(arguments.length), l = T.event.fix(e),
					c = (J.get(this, "events") || Object.create(null))[l.type] || [], d = T.event.special[l.type] || {};
		...
		function Ie(e, t, n, i) {
			...
			if (p && (r = (o = ke(t, e[0].ownerDocument, !1, e, i)).firstChild, 1 === o.childNodes.length && (o = r), r || i)) {
				for (a = (s = T.map(we(o, "script"), _e)).length; u < p; u++) c = o, u !== f && (c = T.clone(c, !0, !0), a && T.merge(s, we(c, "script"))), n.call(e[u], c, u);
				if (a) for (d = s[s.length - 1].ownerDocument, T.map(s, Pe), u = 0; u < a; u++) c = s[u], ye.test(c.type || "") && !J.access(c, "globalEval") && T.contains(d, c) && (c.src && "module" !== (c.type || "").toLowerCase() ? T._evalUrl && !c.noModule && T._evalUrl(c.src, {nonce: c.nonce || c.getAttribute("nonce")}, d) : x(c.textContent.replace(He, ""), c, d))
			}
			return e
		}
		...
		T.extend({
			htmlPrefilter: function (e) {
				...
				if (!(g.noCloneChecked || 1 !== e.nodeType && 11 !== e.nodeType || T.isXMLDoc(e))) for (s = we(a), i = 0, o = (r = we(e)).length; i < o; i++) Me(r[i], s[i]);
				if (t) if (n) for (r = r || we(e), s = s || we(a), i = 0, o = r.length; i < o; i++) qe(r[i], s[i]); else qe(e, a);
		...
		var We = new RegExp("^(" + ne + ")(?!px)[a-z%]+$", "i"), Re = function (e) {
		...
		function Ue(e, t, n) {
			...
			return (n = n || Re(e)) && ("" !== (s = n.getPropertyValue(t) || n[t]) || se(e) || (s = T.style(e, t)), !g.pixelBoxStyles() && We.test(s) && Be.test(t) && (i = a.width, o = a.minWidth, r = a.maxWidth, a.minWidth = a.maxWidth = a.width = s, s = n.width, a.width = i, a.minWidth = o, a.maxWidth = r)), void 0 !== s ? s + "" : s
		}
		...
		var Ye = ["Webkit", "Moz", "ms"], Ve = w.createElement("div").style, Ge = {};
		...
		function it(e, t, n) {
			var i = Re(e), o = (!g.boxSizingReliable() || n) && "border-box" === T.css(e, "boxSizing", !1, i), r = o,
		...
		T.extend({
			...
			T.cssHooks[t] = {
				get: function (e, n, i) {
					...
					var o, r = Re(e), s = !g.scrollboxSize() && "absolute" === r.position,
						a = (s || i) && "border-box" === T.css(e, "boxSizing", !1, r), l = i ? nt(e, t, i, a, r) : 0;
		...
		function ft(e, t, n) {
			...
			for (!function (e, t) {
				var n, i, o, r, s;
				for (n in e) if (o = t[i = V(n)], r = e[n], Array.isArray(r) && (o = r[1], r = e[n] = r[0]), n !== i && (e[i] = r, delete e[n]), (s = T.cssHooks[i]) && "expand" in s) for (n in r = s.expand(r), delete e[i], r) n in e || (e[n] = r[n], t[n] = o); else t[i] = o
			}(d, c.opts.specialEasing); r < s; r++) if (i = ft.prefilters[r].call(c, e, d, c.opts)) return y(i.stop) && (T._queueHooks(c.elem, c.opts.queue).stop = i.stop.bind(i)), i;
		...
		T.Animation = T.extend(ft, {
			tweeners: {
				...
				if ((l = !T.isEmptyObject(t)) || !T.isEmptyObject(f)) for (i in u && 1 === e.nodeType && (n.overflow = [h.overflow, h.overflowX, h.overflowY], null == (c = g && g.display) && (c = J.get(e, "display")), "none" === (d = T.css(e, "display")) && (c ? d = c : (pe([e], !0), c = e.style.display || c, d = T.css(e, "display"), pe([e]))), ("inline" === d || "inline-block" === d && null != c) && "none" === T.css(e, "float") && (l || (p.done((function () {
					h.display = c
				})), null == c && (d = h.display, c = "none" === d ? "" : d)), h.display = "inline-block")), n.overflow && (h.overflow = "hidden", p.always((function () {
					h.overflow = n.overflow[0], h.overflowX = n.overflow[1], h.overflowY = n.overflow[2]
				}))), l = !1, f) l || (g ? "hidden" in g && (v = g.hidden) : g = J.access(e, "fxshow", {display: c}), r && (g.hidden = !v), v && pe([e], !0), p.done((function () {
			...
			fadeTo: function (e, t, n, i) {
				...
				return !1 !== e && (e = e || "fx"), this.each((function () {
					var t, n = J.get(this), i = n[e + "queue"], o = n[e + "queueHooks"], r = T.timers,
						s = i ? i.length : 0;
		...
		T.fn.extend({
			...
			addClass: function (e) {
				...
				if ((t = bt(e)).length) for (; n = this[l++];) if (o = wt(n), i = 1 === n.nodeType && " " + mt(o) + " ") {
				...
				return "boolean" == typeof t && i ? t ? this.addClass(e) : this.removeClass(e) : y(e) ? this.each((function (n) {
					...
					var t, o, r, s;
					if (i) for (o = 0, r = T(this), s = bt(e); t = s[o++];) r.hasClass(t) ? r.removeClass(t) : r.addClass(t); else void 0 !== e && "boolean" !== n || ((t = wt(this)) && J.set(this, "__className__", t), this.setAttribute && this.setAttribute("class", t || !1 === e ? "" : J.get(this, "__className__") || ""))
				}))
			}, hasClass: function (e) {
				var t, n, i = 0;
				...
				option: {
					...
					get: function (e) {
						var t, n, i, o = e.options, r = e.selectedIndex, s = "select-one" === e.type, a = s ? null : [],
							l = s ? r + 1 : o.length;
						for (i = r < 0 ? l : s ? r : 0; i < l; i++) if (((n = o[i]).selected || i === r) && !n.disabled && (!n.parentNode.disabled || !j(n.parentNode, "optgroup"))) {
		...
		T.extend(T.event, {
			trigger: function (e, t, i, o) {
				var r, s, a, l, c, d, u, p, h = [i || w], v = f.call(e, "type") ? e.type : e,
				...
				if (s = p = a = i = i || w, 3 !== i.nodeType && 8 !== i.nodeType && !kt.test(v + T.event.triggered) && (v.indexOf(".") > -1 && (g = v.split("."), v = g.shift(), g.sort()), c = v.indexOf(":") < 0 && "on" + v, (e = e[T.expando] ? e : new T.Event(v, "object" == typeof e && e)).isTrigger = o ? 2 : 3, e.namespace = g.join("."), e.rnamespace = e.namespace ? new RegExp("(^|\\.)" + g.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, e.result = void 0, e.target || (e.target = i), t = null == t ? [e] : T.makeArray(t, [e]), u = T.event.special[v] || {}, o || !u.trigger || !1 !== u.trigger.apply(i, t))) {
					...
					for (r = 0; (s = h[r++]) && !e.isPropagationStopped();) p = s, e.type = r > 1 ? l : u.bindType || v, (d = (J.get(s, "events") || Object.create(null))[e.type] && J.get(s, "handle")) && d.apply(s, t), (d = c && s[c]) && d.apply && G(s) && (e.result = d.apply(s, t), !1 === e.result && e.preventDefault());
		...
		var St = n.location, Ct = {guid: Date.now()}, $t = /\?/;
		...
		Wt.href = St.href, T.extend({
			...
			ajax: function (e, t) {
				...
				var i, o, r, s, a, l, c, d, u, p, f = T.ajaxSetup({}, t), h = f.context || f,
					v = f.context && (h.nodeType || h.jquery) ? T(h) : T.event, g = T.Deferred(),
					y = T.Callbacks("once memory"), m = f.statusCode || {}, b = {}, x = {}, k = "canceled", S = {
						readyState: 0, getResponseHeader: function (e) {
							var t;
							if (c) {
								if (!s) for (s = {}; t = _t.exec(r);) s[t[1].toLowerCase() + " "] = (s[t[1].toLowerCase() + " "] || []).concat(t[2]);
								t = s[e.toLowerCase() + " "]
							}
							...
							var t;
							if (e) if (c) S.always(e[S.status]); else for (t in e) m[t] = [m[t], e[t]];
							return this
						}, abort: function (e) {
							var t = e || k;
				...
				function C(e, t, s, l) {
					...
					}(f, S, s)), !u && T.inArray("script", f.dataTypes) > -1 && (f.converters["text script"] = function () {
					}), b = function (e, t, n, i) {
		...
		g.cors = !!Xt && "withCredentials" in Xt, g.ajax = Xt = !!Xt, T.ajaxTransport((function (e) {
			...
			if (g.cors || Xt && !e.crossDomain) return {
				send: function (o, r) {
					...
					t = function (e) {
						return function () {
							t && (t = i = a.onload = a.onerror = a.onabort = a.ontimeout = a.onreadystatechange = null, "abort" === e ? a.abort() : "error" === e ? "number" != typeof a.status ? r(0, "error") : r(a.status, a.statusText) : r(Ut[a.status] || a.status, a.statusText, "text" !== (a.responseType || "text") || "string" != typeof a.responseText ? {binary: a.response} : {text: a.responseText}, a.getAllResponseHeaders()))
						}
	...
	window.$ = window.jQuery = n(0), n(3), n(4), $(document).ready((function () {
		...
		e(), $(window).scroll((function () {
			...
			responsive: [{breakpoint: 1024, settings: {slidesToShow: 1, slidesToScroll: 1, arrows: !1}}]
			...
			responsive: [{breakpoint: 1024, settings: {slidesToShow: 1, slidesToScroll: 1, arrows: !1, dots: !0}}]
		}), $(".js-header__menu__btn").click((function () {
